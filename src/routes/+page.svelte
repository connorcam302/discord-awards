...
<div class="mx-auto max-w-screen-lg">
	...
	>
		<div class="flex flex-col gap-4">
			<div>
				...
				pals. As the hours pass each year, we come to know a bit more about eachother, sometimes
				it's as mysterious as Joe's relationship with his Dad other times its as unwanted as Steve's
				sex life.
				<br />
				<br />
		...
		<div class="flex flex-col gap-4">
			...
			be voided), but for two person awards you are able to nominte yourself. You will need to be logged
			in to vote and nominate so an audit trail exists.
		</div>
		<div class="flex flex-col gap-4">
			<div class="flex flex-col items-center gap-2 text-left">
				...
				<div class="flex w-96 items-center gap-2">
					...
					<div class="w-96 text-neutral-400">
						Nominations are open and you are free to submit any nominations you want. Nominations
						will be locked on the 10th of December. Up until this point you are able to change your
						nominations.
					</div>
				</div>
				<div class="flex w-96 items-center gap-4">
				...
				<div class="flex w-96 items-center gap-2">
					...
					<div class="w-96 text-neutral-400">
						Based on the nominations, the top 3 to 5 nominated will be eligible to be voted on. In
						the event of a tie, multiple winners will be declared. Up until voting closes, you are
						able to change your vote.
					</div>
				</div>
				<div class="flex w-96 items-center gap-4">
					<div class="h-6 w-6 rounded-full bg-white"></div>
	...
	{#if isSignedIn}
		<div class="flex items-center justify-center py-8">
			<a href="/winners">
				<Button class="h-16 w-96 text-3xl font-bold">Go to Winners</Button>
			</a>
		</div>
	{/if}
</div>
